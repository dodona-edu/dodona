...
function initInstitutionSelectionTable(institutionId: number): void {
    ...
    const institutionCollapse = new Collapse(institutionPanel.querySelector(".panel-collapse"), { toggle: false });
    const confirmCollapse = new Collapse(confirmPanel.querySelector(".panel-collapse"), { toggle: false });
