module NotificationsHelper
  def base_notifiable_url_params(notification)
    ...
    return { controller: 'reviews', action: 'index', review_session_id: notification.notifiable_id } if notification.notifiable_type == 'ReviewSession'
  end
  ...
  def notifiable_url(notification)
    ...
    return review_session_reviews_path(notification.notifiable_id) if notification.notifiable_type == 'ReviewSession'
  end
