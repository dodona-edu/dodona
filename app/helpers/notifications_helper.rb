module NotificationsHelper
  def base_notifiable_url_params(notification)
    return { controller: 'exports', action: 'show', id: notification.notifiable_id } if notification.notifiable_type == 'Export'
  ...
  def notifiable_url(notification)
    return export_path(notification.notifiable_id) if notification.notifiable_type == 'Export'
