...
class Exercise < ApplicationRecord
  ...
  scope :by_programming_language, ->(programming_language) { joins(:programming_language).includes(:programming_language).where(programming_languages: {name: programming_language})}
