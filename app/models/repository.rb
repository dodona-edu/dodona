...
class Repository < ApplicationRecord
  ...
  scope :owned_by_institution, ->(institution) { where(id: RepositoryAdmin.joins(:user).where(users: { institution_id: institution&.id }).group(:repository_id).pluck(:repository_id))}
