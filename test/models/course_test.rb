...
class CourseTest < ActiveSupport::TestCase
  ...
  test 'Users correct by exercise should be updated correctly' do
    course = courses(:course1)
    series = create :series, course: course, activity_count: 1
    user = users(:student)

    assert_nil course.users_correct_by_exercise[series.exercises[0].id]
    ...
    assert_equal 1, course.users_correct_by_exercise[series.exercises[0].id]
  end

  test 'Users correct by exercise should not be updated for submission outside course' do
    course = courses(:course1)
    series = create :series, course: course, activity_count: 1
    user = users(:student)
  ...
  test 'Users tried by exercise should be updated correctly' do
    course = courses(:course1)
    series = create :series, course: course, activity_count: 1
    user = users(:student)

    assert_nil course.users_tried_by_exercise[series.exercises[0].id]
    ...
    assert_equal 1, course.users_tried_by_exercise[series.exercises[0].id]
  ...
  test 'Users tried by exercise should not be updated for submission outside course' do
    course = courses(:course1)
    series = create :series, course: course, activity_count: 1
    user = users(:student)
  ...
  test 'Users read by content page should be updated correctly' do
    course = courses(:course1)
    ...
    assert_nil course.users_read_by_content_page[content_page.id]
    ...
    assert_equal 1, course.users_read_by_content_page[content_page.id]
  end

  test 'Users read by content page should not be updated for read state outside course' do
    course = courses(:course1)
    content_page = create :content_page
    series = create :series, course: course, activity_count: 1
    series.content_pages << content_page
