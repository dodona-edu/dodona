...
(function(a, b) {
    ...
    a.extend(a.ui, {
        ...
        scrollParent: function() {
            var b;
            return navigator.userAgent.match(/MSIE ([0-9]+)\./) && /(static|relative)/.test(this.css("position")) || /absolute/.test(this.css("position")) ? b = this.parents().filter(function() {
...
(function(a, b) {
    ...
    a(document).mouseup(function(a) {
        ...
        _mouseMove: function(b) {
            return !navigator.userAgent.match(/MSIE ([0-9]+)\./) || document.documentMode >= 9 || !!b.button ? this._mouseStarted ? (this._mouseDrag(b), b.preventDefault()) : (this._mouseDistanceMet(b) && this._mouseDelayMet(b) && (this._mouseStarted = this._mouseStart(this._mouseDownEvent, b) !== !1, this._mouseStarted ? this._mouseDrag(b) : this._mouseUp(b)), !this._mouseStarted) : this._mouseUp(b)
        },
        _mouseUp: function(b) {
    ...
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        _mouseDrag: function(b) {
            ...
            var l = k.apply(this, [b, i, j]),
                m = navigator.userAgent.match(/MSIE ([0-9]+)\./) && a.browser.version < 7,
                n = this.sizeDiff;
        ...
        _proportionallyResize: function() {
            ...
            for (var d = 0; d < this._proportionallyResizeElements.length; d++) {
                ...
                if (!navigator.userAgent.match(/MSIE ([0-9]+)\./) || !a(c).is(":hidden") && !a(c).parents(":hidden").length) e.css({
        ...
        _renderProxy: function() {
            ...
            if (this._helper) {
                ...
                var d = navigator.userAgent.match(/MSIE ([0-9]+)\./) && a.browser.version < 7,
                    e = d ? 1 : 0,
                    f = d ? 2 : -1;
